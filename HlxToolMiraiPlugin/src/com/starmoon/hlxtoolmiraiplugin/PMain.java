...
public class PMain extends JavaPlugin {
	...
	private static List<Long> admins=new ArrayList<>();
	...
	private static List<Long> adminGroupIDs=new ArrayList<>();
	static PrintWriter pw;
	static StringWriter sw=new StringWriter();
	private static f f;
    private static HashMap<Integer, Timer> sTimers=new HashMap<>();
	static {
		admins.add(host);
	}
